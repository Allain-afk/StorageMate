...
class RecentsListView extends StatefulWidget {
  const RecentsListView({super.key, this.items = const []});
  final List<FileItem> items;
  @override
  State<RecentsListView> createState() => _RecentsListViewState();
}

class _RecentsListViewState extends State<RecentsListView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: items.isEmpty
          ? const Center(child: Text('No rarely used items yet'))
          : ListView.separated(
